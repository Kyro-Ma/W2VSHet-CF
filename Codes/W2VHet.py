...
if __name__ == '__main__':
    ...
    for df_path, meta_df_path, w2vec_path, threshold in zip(df_path_list, meta_df_path_list, w2vec_path_list,
        ...
        if 'beauty' in df_path:
            output_path = f'../Datasets/Word2vec+HeteroGNN_hidden_channels={hidden_channels}_beauty.xlsx'
        else:
            output_path = f'../Datasets/Word2vec+HeteroGNN_hidden_channels={hidden_channels}_fashion.xlsx'
